...
public class ZonaController {
    ...
    @GetMapping("/all")
    public ResponseEntity<List<ZonaAllResponse>> getAll(){
        return ResponseEntity.ok().body(zonaService.getAll());
    }
    ...
    @PutMapping
    public ResponseEntity<ZonaResponse> updateZona(@RequestBody Zona zona) {
